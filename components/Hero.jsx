...
const title = ["CLOUD", "&", "DEVSECOPS", "ENGINEER"];
const devSecOpsText = [
  "I",
  "have",
  "a",
...
export default function Hero() {
  return (
    <section className="pt-12  min-h-[80vh]  bg-no-repeat bg-bottom dark:bg-none bg-cover">
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          {/* text  */}
          <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
            <div className="text-sm uppercase font-semibold mb-4 text-primary tracking-[4px]">
              <TextReveal delay={0.5} words={title} />
            </div>
            <h1 className="h1 mb-4">
              {/* Hello I Am Badhon Biswas */}
              <TextReveal delay={1} words={word} />
            </h1>
            <div className="subtitle max-w-[490px] mx-auto xl:mx-0">
              <TextReveal delay={1.5} words={devSecOpsText} />
            </div>
            {/* button  */}
            <div className="flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12">
              ...
              <SlideIn direction="right" delay={2.5}>
